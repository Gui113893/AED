...
int main(void) {
  ...
  fptr = fopen("output_functions_iterations_count.txt", "w");

  fprintf(fptr, "\n f1 \n");
  fprintf(fptr, "      n       f1(n)   f1(n)/f1(n/2)\n");
  fprintf(fptr, "-------  ----------  --------------\n");

  for (n = start_n; n < end_n; n *= 2) {
    result = f1(n);
    fprintf(fptr, "%7u  %10u", n, result);

    if (n > start_n) {
      ratio = (double)result / (double)previous;
      fprintf(fptr, "  %14.5f", ratio);
    }
  ...
  fprintf(fptr, "\n f2 \n");
  fprintf(fptr, "      n       f2(n)   f2(n)/f2(n/2)\n");
  fprintf(fptr, "-------  ----------  --------------\n");
  ...
  fprintf(fptr, "\n f3 \n");
  fprintf(fptr, "      n       f3(n)   f3(n)/f3(n/2)\n");
  fprintf(fptr, "-------  ----------  --------------\n");
  ...
  fprintf(fptr, "\n f4 \n");
  fprintf(fptr, "      n       f4(n)   f4(n)/f4(n/2)\n");
  fprintf(fptr, "-------  ----------  --------------\n");
  ...
  fprintf(fptr, "\n f5 \n");
  fprintf(fptr, "      n       f5(n)   f5(n)/f5(n/2)\n");
  fprintf(fptr, "-------  ----------  --------------\n");
  ...
  fprintf(fptr, "\n f6 \n");
  fprintf(fptr, "      n       f6(n)    f6(n)/f6(n/2)\n");
  fprintf(fptr, "-------  ----------  --------------\n");
  ...
  fprintf(fptr, "\n f7 \n");
  fprintf(fptr, "      n       f7(n)   f7(n)/f7(n/2)\n");
  fprintf(fptr, "-------  ----------  --------------\n");
