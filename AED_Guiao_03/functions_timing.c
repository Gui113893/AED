...
int main(void) {
  ...
  FILE *fptr;
  fptr = fopen("output_functions_timing_3.txt", "w");

  fprintf(fptr, "\n f1 \n");
  fprintf(fptr, "          n    time1(n)   time1(n)/time1(n/10)\n");
  fprintf(fptr, "-----------  ----------  ---------------------\n");
  ...
  for (n = start_n; n <= end_n; n *= 10) {
    ...
    fprintf(fptr, "%11d  %9.3e", n, exec_time);

    if (n > start_n) {
      ratio = exec_time / prev_exec_time;
      fprintf(fptr, "  %21.5e", ratio);
    }
  ...
  fprintf(fptr, "\n f2 \n");
  fprintf(fptr, "          n    time2(n)   time2(n)/time2(n/10)\n");
  fprintf(fptr, "-----------  ----------  ---------------------\n");
  ...
  fprintf(fptr, "\n f3 \n");
  fprintf(fptr, "          n    time3(n)   time3(n)/time3(n/10)\n");
  fprintf(fptr, "-----------  ----------  ---------------------\n");
  ...
  fprintf(fptr, "\n f4 \n");
  fprintf(fptr, "          n    time4(n)   time4(n)/time4(n/10)\n");
  fprintf(fptr, "-----------  ----------  ---------------------\n");
  ...
  fprintf(fptr, "\n f5 \n");
  fprintf(fptr, "          n    time5(n)   time5(n)/time5(n/10)\n");
  fprintf(fptr, "-----------  ----------  ---------------------\n");
  ...
  fprintf(fptr, "\n f6 \n");
  fprintf(fptr, "          n    time6(n)   time6(n)/time6(n/10)\n");
  fprintf(fptr, "-----------  ----------  ---------------------\n");
  ...
  fprintf(fptr, "\n f7 \n");
  fprintf(fptr, "          n    time7(n)    time7(n)/time7(n/2)\n");
  fprintf(fptr, "-----------  ----------  ---------------------\n");
